...
public class ProjectController {
    ...
    public void inviteProject(@PathVariable Long projectId, @RequestBody @Valid InviteProjectRequest request, @AuthenticationPrincipal UserDetailsImpl userDetails) {
        projectService.inviteProject(userDetails.user().getId(), projectId, request.getEmails());
    }
}
